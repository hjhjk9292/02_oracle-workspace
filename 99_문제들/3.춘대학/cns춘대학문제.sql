...
CREATE TABLE TB_CLASS_TYPE(
    NO VARCHAR2(5) PRIMARY KEY, -- 컬럼 레벨 방식
    NAME VARCHAR2(10)
);
...
--   WHERE COACH_PROFESSOR_NO = PROFESSOR_NO; -- 오답
