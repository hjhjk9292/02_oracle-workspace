...
SELECT EMP_NAME, SALARY * 12, (SALARY + SALARY * BONUS) * 12, ((SALARY + SALARY * BONUS) * 12) - (SALARY * 12 *1.03)
FROM EMPLOYEE;
...
FROM EMPLOYEE;
--WHERE HIRE_DATE >= TO_CHAR(SYSDATE '2024')
