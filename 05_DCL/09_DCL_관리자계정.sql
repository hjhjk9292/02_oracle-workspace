...
-- 3_2. TABLESPACE 할당 (SAMPLE 계정에게 테이블 만들 수 있는 공간 할당)
...
GRANT SELECT ON KH.EMPLOYEE TO SAMPLE; -- KH 계정이 갖고 있는 EMPLOYEE라는 테이블을 조회할 수 있는 권한을 줄게
...
/*
    ...
    CONNECT : 접속할 수 있는 권한 CREATE SESSION (커넥트와 크리에이트세션 동일한 의미)
